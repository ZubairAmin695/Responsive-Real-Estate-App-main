  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      ...
      <section id='testimonials' className='lg:w-[95%] w-full  h-fit m-auto bg-cover bg-center rounded-xl
        flex justify-center flex-col items-start lg:px-20 px-6 py-20 gap-20'> 

        <div className='flex flex-col justify-center items-start gap-4'>
          <h1 data-aos="zoom-in" className='text-blue-500 dark:text-white'>OUR CLIENTS</h1>
        ...
        <div id='clients-box' className='grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8 w-full'>

          {
            client.map((item,index)=>(
              ...
              <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-gray-900
                hover:bg-blue-100 cursor-pointer p-12 flex flex-col justify-center items-center
                 gap-6 rounded-xl w-full'>
                  ...
                  <div className='flex justify-start items-start gap-2 w-full'>
                    <FaStar className='sie-4 text-yellow-400' />
                    <FaStar className='sie-4 text-yellow-400' />
                    <FaStar className='sie-4 text-yellow-400' />
                    <FaStar className='sie-4 text-yellow-400' />
                    <FaStar className='sie-4 text-yellow-400' />
